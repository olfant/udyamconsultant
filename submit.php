...
$crm_website = 'UDYAMCONSULTANT.COM';
...
if (isset($_POST['form_type']) && ($_POST['form_type'] == "MSME Cancel")) {
    ...
    $sql = "INSERT INTO msme_form (form_name,applicant_name,mobile_number,email_id,udyam_number,business_name,total_amount,payment_status,terms_of_service,cancel_reason)     
     VALUES ('" . $_POST["form_name"] . "','" . $_POST["applicant_name"] . "','" . $_POST["mobile_number"] . "', '" . $_POST["email_id"] . "','" . $_POST["udyam_number"] . "','" . $_POST["business_name"] . "', 
          '" . $product_price . "',    '" . $payment_status . "','Checked','" . $_POST["cancel_reason"]. "')";
...
if (isset($_POST['form_id']) && $_POST['form_id'] === 'update_udyam_certificate') {
    ...
    $opt_selected  = $_POST['opt_selected'] ?? '';
    $updated_details = $_POST['updated_details'] ?? '';

    $sql = "SELECT product_price 
            FROM product_lists 
            WHERE product_name = '" . $conn->real_escape_string($_POST['form_id']) . "'";
    ...
    $sql = "INSERT INTO $table (
                ...
                '" . $conn->real_escape_string($form_name) . "',
                '" . $conn->real_escape_string($udyam_number) . "',
                '" . $conn->real_escape_string($applicant_name) . "',
                '" . $conn->real_escape_string($mobile_number) . "',
                '" . $conn->real_escape_string($email_id) . "',
                '" . $conn->real_escape_string($opt_selected) . "',
                '" . $conn->real_escape_string($link_1) . "',
                '" . $conn->real_escape_string($updated_details) . "',
                '" . $conn->real_escape_string($product_price) . "',
                '" . $payment_status . "',
...
if ((isset($_POST['form_id'])) && ($_POST['form_id'] == 'print_udyam_registration')) {
    ...
    $row                  = $result->fetch_assoc();
    $product_price        = $row["product_price"];
    $sql                  = "INSERT INTO $table (form_name, applicant_name, mobile_number, email_id, opt_selected, uam_number, updated_details, aadhaar_number,
     total_amount, payment_status,order_id, terms_of_service, office_state)

            VALUES ( '" . $_POST["form_name"] . "', '" . $_POST["applicant_name"] . "', '" . $_POST["mobile_number"] . "',
             '" . $_POST["email_id"] . "','" . $_POST["opt_selected"] . "','" . $_POST["uam_number"] . "','" . $_POST["updated_details"] . "', '" . $_POST["aadhaar_number"] . "', '" . $product_price . "', '" . $payment_status . "',
